...
// document.ELEMENT_NODE pour obtenir les élements qui peuvent avoir des enfants et .TEXT pour les éléments feuille (peuvent pas avoir d'enfants)
function afficherEnfant(noeud, indice) {
    ...
    if (noeud.nodeType === document.ELEMENT_NODE) {
        ...
        console.error("Type de noeud incorect");
    }

}
console.log(afficherEnfant(document.body, 0));
